      ...
      {infoClanes && (
        <div className="container-custom4">
          <div className="header-custom4">
            ...
            <div>
              {infoClanes?.clan.miembros.length}/{infoClanes?.clan.cuposClan}{" "}
              miembros
            </div>
            <div>
            ...
            <div>
              <button
                ...
                onClick={handleAdministrarClick}
              >
                Administrar
              </button>
            </div>
...
const DatosClanCabecera = ({ id }) => {
  ...
  return (
    <div className="contain-clan-admin">
      <img
        src={datosAccounts?.imagenUrl}
        alt="Imagen"
        className="imagen-clan-admin"
      />
      <div className="nombre-clan-admin">
        Clan {datosAccounts?.nombreCuenta}
      </div>
    </div>
  );
};
